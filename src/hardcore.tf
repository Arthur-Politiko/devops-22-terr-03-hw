...
#   filename = "./hardcore_inventory.ini"
# }
...
variable web_provision {
  type        = bool
  default     = true
  description = "Enable or disable web servers provisioning with Ansible"
}
